...
public class DeleteUserTask extends AsyncTask<String, Void, Boolean> {
    // http://findme-env.elasticbeanstalk.com/deleteuser.php

    String username = "";
    String password = "";

    public DeleteUserTask(String username, String password) {
    ...
    protected void onPostExecute(Boolean success) {
        if (success) {
            Log.e("DeleteUser","Success");
        }
        else {
            Log.e("DeleteUser","Failure");
        }
    }
}
